...
if __name__ == "__main__":
    ...
    print(emoji.emojize(':heartbeat:'))
    for emo2 in list_emojis:
        print(emoji.emojize(str(emo2)))
        #print((emoji.emojize("emoji is : " + str(emo2)+"  ,  ")).encode("utf-8"))
        #print("____")
        #print(emoji.emojize("emoji is : " + str(emo2)+"  ,  "))
        print("___________________")

    print("+++++++++++++++++++++++")


    #print((emoji.emojize("{} {}".format(args.text,' '.join(emojis)), use_aliases=True)).encode("utf-8"))
